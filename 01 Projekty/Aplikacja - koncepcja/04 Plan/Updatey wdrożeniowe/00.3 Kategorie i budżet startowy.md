...
- zrealizowane elementy:
  ...
  - stan pusty dla pierwszej konfiguracji
- przyjęty model MVP:
  - budżet miesiąca jest opcjonalny
  - limity kategorii są niezależne od budżetu miesiąca
  - kategorie bez limitu pozostają aktywne i są traktowane jako nielimitowane
