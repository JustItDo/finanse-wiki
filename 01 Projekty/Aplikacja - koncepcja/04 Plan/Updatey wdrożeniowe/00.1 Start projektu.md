...
- zrealizowane elementy:
  - projekt `Expo + React Native + TypeScript`
  - nawigacja między głównymi ekranami
  - wspólne komponenty UI
  - motyw, spacing i typografia
  - konfiguracja `eslint`, `prettier`, aliasów i buildów web
- uwaga:
  - ten stan nie został jeszcze domknięty osobnym commitem w repo aplikacji
